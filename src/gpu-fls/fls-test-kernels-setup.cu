...
#include "fls-test-kernels-bindings.hpp"
...
// uint32_t
template <>
void verify_bitunpack(const KernelSpecification spec, const uint32_t *__restrict in,
  ...
  case TEST_STATELESS_1_1: {
    ...
    kernels::fls::global::test::bitunpack<
