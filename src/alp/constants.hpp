...
struct Constants<float> {
	...
	static constexpr uint32_t SIGN_BIT_MASK = 0x7FFFFFFF;
	static constexpr uint32_t EXPONENTIAL_BITS_MASK = 0x7F800000;
...
struct Constants<double> {
	...
	static constexpr uint64_t SIGN_BIT_MASK = 0x7FFFFFFFFFFFFFFF;
	static constexpr uint64_t EXPONENTIAL_BITS_MASK = 0x7FF0000000000000;
