            ...
            [
                DataSource(
                    BenchmarkCommand(
                        ...
                        n_vecs=n_vecs if unpacker != "old_fls_adjusted" else 1,
                        n_vals=1 if unpacker != "old_fls_adjusted" else 32,
                ...
                for unpacker, label, color in zip(
                    ...
                    [
                        ...
                        f"stateful-register-branchless-2b-{n_vecs}v",
                        f"stateless-branchless-{n_vecs}v",
                        f"stateful-branchless-{n_vecs}v",
                        f"old-fls-adjusted-1v",
                    ],
                    range(0, 5),
                )
            ],
