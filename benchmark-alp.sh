...
UNPACK_N_VALUES="1 4"
DATATYPE_WIDTH=32
EXPERIMENTS="alp_decompress alp_query"
N_VEC=10000
OUTPUT_DIR="alp-data"
...
mkdir $OUTPUT_DIR
parallel --progress -j 1 ./collect-traces.py  -tr 3 -m $METRICS -o $OUTPUT_DIR/{2}-{1}-{5} -c \"./bin/executable {2} {1} {5} {3} {4} $DATATYPE_WIDTH random vbw-0-16 $N_VEC 0\" ::: $KERNELS_TO_VERIFY ::: $EXPERIMENTS ::: $UNPACK_N_VECTORS ::: $UNPACK_N_VALUES ::: $PATCHERS_TO_VERIFY
