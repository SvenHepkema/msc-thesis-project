...
struct BenchmarkResult {
  ...
  void log_result(const enums_nvcomp::ComparisonType comparison_type,
                  ...
                  const size_t n_bytes, const std::string data_name) const {
...
template <typename T> struct is_equal_to {
  T value;
...
BenchmarkResult benchmark_thrust(const double *input, const size_t value_count,
