...
N_VEC=10000
OUTPUT_DIR="data"
parallel -j 1 ./collect-traces.py  -tr 3 -m global_hit_rate,dram_read_bytes,dram_write_bytes,ipc -o $OUTPUT_DIR/{2}-{1} -c \"./bin/executable {2} {1} 32 random vbw-0-32 $N_VEC 0\" ::: $KERNELS_TO_VERIFY ::: $EXPERIMENTS
